    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="main.php">
                        <div class="brand-logo"></div>
                        <h2 class="brand-text mb-0">Scholarship</h2>
                    </a></li>
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a href="index.html"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span><span class="badge badge badge-warning badge-pill float-right mr-2">1</span></a>
                    <ul class="menu-content">
                        <li class="active"><a href="dashboard-analytics.html"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Analytics">Data Visualization</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" navigation-header"><span>Profile</span>
                </li>
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-list"></i><span class="menu-title" data-i18n="Data List">Scholarships</span></a>
                    <ul class="menu-content">
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-layout"></i><span class="menu-title" data-i18n="Content">Scholarship Types</span></a>
                    <ul class="menu-content">
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-credit-card"></i><span class="menu-title" data-i18n="Card">Scholarship Criteria</span></a>
                    <ul class="menu-content">
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-briefcase"></i><span class="menu-title" data-i18n="Icons">Committes</span></a>
                    <ul class="menu-content">
                        <li><a href="main.php?page=scholarships-committes-list"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Feather">List</span></a>
                        </li>
                        <li><a href="icons-font-awesome.html"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Font Awesome">Create</span></a>
                        </li>
                    </ul>
                </li>

                <li class=" navigation-header"><span>Students</span>
                </li>
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-user"></i><span class="menu-title" data-i18n="User">Users</span></a>
                    <ul class="menu-content">
                        ...
                        <li><a href="main.php?page=admin-user-create"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Create">Create</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="feather icon-unlock"></i><span class="menu-title" data-i18n="Authentication">User Type</span></a>
                <ul class="menu-content">
